...
for s in Pilot03; do
	...
	-stim_times 1 /home/despoB/kaihwang/bin/HTB-MNE/${s}_R4 'TENT(0, 7, 7)' -stim_label 1 R4 \
	-stim_times 2 /home/despoB/kaihwang/bin/HTB-MNE/${s}_R8 'TENT(0, 7, 7)' -stim_label 2 R8 \
	-stim_times 3 /home/despoB/kaihwang/bin/HTB-MNE/${s}_D1 'TENT(0, 7, 7)' -stim_label 3 D1 \
	-stim_times 4 /home/despoB/kaihwang/bin/HTB-MNE/${s}_D2 'TENT(0, 7, 7)' -stim_label 4 D2 \
	...
	-gltsym 'SYM: +1*D1 +1*D2 -1*R4 -1*R8 ' -glt_label 1 D1+D2-R4+R8 \
	-gltsym 'SYM: +1*D2 +1*R8 -1*D1 -1*R4 ' -glt_label 2 D2+R8-D1-R4 \
	-gltsym 'SYM: +1*R8 -1*R4 ' -glt_label 3 R8-R4 \
	-gltsym 'SYM: +1*D2 -1*D1 ' -glt_label 4 D2-D1 \
	-gltsym 'SYM: +1*D2 -1*R8 ' -glt_label 5 R8-D2 \
	-gltsym 'SYM: +1*D1 -1*R4 ' -glt_label 6 D1-R4 \
	-gltsym 'SYM: +1*D2 -1*R4 ' -glt_label 7 D2-R4 \
	-rout \
	-tout \
